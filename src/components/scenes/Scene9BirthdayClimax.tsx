...
const Scene9BirthdayClimax = () => {
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Main birthday wish */}
      <motion.div
        className="relative z-30 mt-4 flex flex-col items-center px-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <p className="text-xs md:text-sm font-display italic text-cinema-cream/60 text-center cinema-subtitle mt-1.5">
          "Who became my best friend… My support… My courage… My love."
        </p>
      </motion.div>

      {/* Telugu */}
      <motion.div
        className="relative z-30 mt-3 px-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 14, duration: 1.5 }}
      >
        <p className="text-xs font-display italic text-cinema-gold/50 text-center cinema-subtitle">
          "Happy Birthday naa bangaram…"
        </p>
        <p className="text-xs font-display italic text-cinema-gold/40 text-center cinema-subtitle mt-1">
          "Nuvvu naa life lo vachinappati nundi everything became better."
        </p>
      </motion.div>
    </div>
  );

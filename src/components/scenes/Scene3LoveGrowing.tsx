  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden">
      ...
      {Array.from({ length: 12 }).map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-[2px] h-[2px] bg-cinema-cream/30 rounded-full"
      ...
      <div className="relative z-30 mb-4 px-8 max-w-md">
        <NarrationText
          lines={[
            ...
            "Because our conversations never wanted to end.",
          ]}
          startDelay={0.5}
          lineGap={2}
        />
      ...
      <div className="relative z-30 mt-5 px-8 max-w-md">
        <NarrationText
          lines={[
            "Calls… Messages… Care… Protection…",
            "Slowly… you became my daily happiness.",
          ]}
          startDelay={6}
          lineGap={2}
        />
      ...
      >
        <p className="text-xs font-display italic text-cinema-gold/50 text-center cinema-subtitle">
          "Roju matladakunda unte day complete avvaledu…"
        </p>
        <p className="text-xs font-display italic text-cinema-gold/50 text-center cinema-subtitle mt-1.5">
          "Nuvvu habit kaadu… necessity aipoyav."
        </p>
      </motion.div>
    </div>
  );
